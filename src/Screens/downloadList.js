...
export default function DownloadList({ navigation })
 ...
 return (
   ...
   <MaterialCommunityIcons name="download-network" style={{fontSize:30,color:'red', marginLeft:20}} />
   <Text style={{fontSize:18,color:'red',fontWeight:'normal', marginLeft:10}}>Current Download (0)</Text>
   </View>
    
   <View style={{width:'100%',height:50, flexDirection:'row', marginTop:0,marginLeft:0,backgroundColor:'#d7d7d9',alignItems:'center'}}>
   <MaterialCommunityIcons name="check-network" style={{fontSize:30,color:'green', marginLeft:20}} />
   <Text style={{fontSize:18,color:'green',fontWeight:'normal', marginLeft:10}}>Complete Download (0)</Text>
   </View>
